    ...
    render() {
        ...
        return <html lang={language ? language.substr(0, 2) : ''}>
            ...
            <body className={`is-${columnCount}-column has-navbar-fixed-top`}>
                ...
                <script type="text/javascript" src="https://cdn.jsdelivr.net/gh/ChenYu-K/ChenYu-K.github.io@master/js/scr/snow.js"></script>
                <canvas class="fireworks" style="position: fixed;left: 0;top: 0;z-index: 1; pointer-events: none;" ></canvas> 
                <script type="text/javascript" src="//cdn.bootcss.com/animejs/2.2.0/anime.min.js"></script> 
                <script type="text/javascript" src="https://cdn.jsdelivr.net/gh/ChenYu-K/ChenYu-K.github.io@master/js/scr/fireworks.js"></script>
            </body>
        </html>;
    }
};
